...
export const StatSkeleton = () => (
  <div className="hud bg-[var(--sheet)] border border-[var(--rule)] rounded-[var(--r-panel)] p-3.5">
...
export const RowSkeleton = () => (
  <div className="hud bg-[var(--sheet)] border border-[var(--rule)] rounded-[var(--r-panel)] p-5">
